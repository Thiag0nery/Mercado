...
public class MicroPerformanceRegressionTest extends BaseTestCase {
        ...
        for (int i = 0; i < numPrepares; i++) {
            if (i % 1000 == 0) {
                ...
                if (lastBlock == 0) {
                    ...
                    double diff = totalTime / (double) lastBlock;
    ...
    public void testBug6359() throws Exception {
        if (runLongTests()) {
            ...
            double secondsSingleQuery = (endSingleQuery - (double) beginSingleQuery) / 1000;
            ...
            double secondsFiveQueries = (endFiveQueries - (double) beginFiveQueries) / 1000;
            ...
            double seconds = (end - (double) begin) / 1000;
