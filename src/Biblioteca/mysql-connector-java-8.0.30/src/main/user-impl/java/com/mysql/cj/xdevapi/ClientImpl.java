        ...
        if (pooling != null) {
            ...
            if (jsonVal != null) {
                if (JsonNumber.class.isAssignableFrom(jsonVal.getClass())) {
                    props.setProperty(ClientProperty.POOLING_MAX_SIZE.getKeyName(), jsonVal.toString());
                } else if (JsonString.class.isAssignableFrom(jsonVal.getClass())) {
            ...
            if (jsonVal != null) {
                if (JsonNumber.class.isAssignableFrom(jsonVal.getClass())) {
                    props.setProperty(ClientProperty.POOLING_MAX_IDLE_TIME.getKeyName(), jsonVal.toString());
                } else if (JsonString.class.isAssignableFrom(jsonVal.getClass())) {
            ...
            if (jsonVal != null) {
                if (JsonNumber.class.isAssignableFrom(jsonVal.getClass())) {
                    props.setProperty(ClientProperty.POOLING_QUEUE_TIMEOUT.getKeyName(), jsonVal.toString());
                } else if (JsonString.class.isAssignableFrom(jsonVal.getClass())) {
