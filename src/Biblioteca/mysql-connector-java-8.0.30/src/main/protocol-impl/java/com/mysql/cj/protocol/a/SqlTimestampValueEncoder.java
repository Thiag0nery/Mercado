...
public class SqlTimestampValueEncoder extends AbstractValueEncoder {
    ...
    public String getString(BindValue binding) {
        Timestamp x = adjustTimestamp((Timestamp) ((Date) binding.getValue()).clone(), binding.getField(), binding.keepOrigNanos());
        ...
        switch (binding.getMysqlType()) {
            ...
            case TIME:
                ...
                writeTime(msg, InternalTime.from(calendar,
                        adjustTimestamp((Timestamp) ((Date) binding.getValue()).clone(), binding.getField(), binding.keepOrigNanos()).getNanos()));
                return;
            case CHAR:
            case VARCHAR:
            case TINYTEXT:
