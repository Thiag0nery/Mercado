        ...
        switch (binding.getMysqlType()) {
            ...
            case DATE:
                ...
                if (dt instanceof LocalDate) {
                    ...
                    sb.append(((ChronoLocalDate) dt).format(TimeUtil.DATE_FORMATTER));
                    sb.append("'");
                    return sb.toString();
                } else if (dt instanceof LocalDateTime) {
                    sb = new StringBuilder("'");
                    sb.append(((ChronoLocalDateTime<LocalDate>) dt).format(TimeUtil.DATE_FORMATTER));
                    sb.append("'");
                    return sb.toString();
                }
            ...
            case TIME:
                ...
                if (dt instanceof LocalTime) {
                    ...
                    sb = new StringBuilder("'");
                    sb.append(adjustLocalTime(((ChronoLocalDateTime<LocalDate>) dt).toLocalTime(), binding.getField()).format(TimeUtil.TIME_FORMATTER_WITH_OPTIONAL_MICROS));
                    sb.append("'");
                    return sb.toString();
