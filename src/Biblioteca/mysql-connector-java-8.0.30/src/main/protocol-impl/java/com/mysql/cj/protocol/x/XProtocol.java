...
public class XProtocol extends AbstractProtocol<XMessage> implements Protocol<XMessage> {
    ...
    public <T extends QueryResult> T readQueryResult(ResultBuilder<T> resultBuilder) {
        try {
            ...
            while (!done) {
                ...
                Class<? extends GeneratedMessageV3> msgClass = mess.getMessage().getClass();
    ...
    public ServerCapabilities readServerCapabilities() {
        try {
            ...
            return new XServerCapabilities(((MysqlxConnection.CapabilitiesOrBuilder) this.reader.readMessage(null, ServerMessages.Type.CONN_CAPABILITIES_VALUE).getMessage())
