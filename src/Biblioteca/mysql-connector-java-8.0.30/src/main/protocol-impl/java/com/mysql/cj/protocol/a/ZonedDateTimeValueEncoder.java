    ...
    public String getString(BindValue binding) {
        switch (binding.getMysqlType()) {
            ...
            case LONGTEXT:
                sb = new StringBuilder("'");
                sb.append(
                        ((ChronoZonedDateTime<LocalDate>) binding.getValue()).format(this.sendFractionalSeconds.getValue() && ((ZonedDateTime) binding.getValue()).getNano() > 0
        ...
        switch (binding.getMysqlType()) {
            ...
            case LONGTEXT:
                intoPacket.writeBytes(StringSelfDataType.STRING_LENENC,
                        StringUtils.getBytes(((ChronoZonedDateTime<LocalDate>) binding.getValue())
