    ...
    public String getString(BindValue binding) {
        switch (binding.getMysqlType()) {
            ...
            case DATE:
                ...
                sb.append(((ChronoLocalDateTime<LocalDate>) binding.getValue()).format(TimeUtil.DATE_FORMATTER));
                sb.append("'");
                return sb.toString();
            case TIME:
                sb = new StringBuilder("'");
                sb.append(adjustLocalDateTime(
                        LocalDateTime.of(((LocalDateTime) binding.getValue()).toLocalDate(), ((ChronoLocalDateTime<LocalDate>) binding.getValue()).toLocalTime()),
            ...
            case LONGTEXT:
                sb = new StringBuilder("'");
                sb.append(
                        ((ChronoLocalDateTime<LocalDate>) binding.getValue()).format(this.sendFractionalSeconds.getValue() && ((LocalDateTime) binding.getValue()).getNano() > 0
