...
public class SqlDateValueEncoder extends AbstractValueEncoder {
    ...
    public String getString(BindValue binding) {
        switch (binding.getMysqlType()) {
            ...
            case MEDIUMTEXT:
            case LONGTEXT:
                return binding.getCalendar() != null ? TimeUtil.getSimpleDateFormat("''yyyy-MM-dd''", binding.getCalendar()).format((java.util.Date) binding.getValue())
                        : TimeUtil.getSimpleDateFormat(null, "''yyyy-MM-dd''", this.serverSession.getDefaultTimeZone()).format((java.util.Date) binding.getValue());
            case DATETIME:
            case TIMESTAMP:
    ...
    public void encodeAsBinary(Message msg, BindValue binding) {
        ...
        switch (binding.getMysqlType()) {
            ...
            case MEDIUMTEXT:
            case LONGTEXT:
                String val = binding.getCalendar() != null ? TimeUtil.getSimpleDateFormat("yyyy-MM-dd", binding.getCalendar()).format((java.util.Date) binding.getValue())
                        : TimeUtil.getSimpleDateFormat(null, "yyyy-MM-dd", this.serverSession.getDefaultTimeZone()).format((java.util.Date) binding.getValue());
